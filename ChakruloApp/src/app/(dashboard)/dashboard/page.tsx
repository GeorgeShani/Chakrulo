    ...
    <section className="w-full h-full flex items-center pt-16 justify-center dashboard-home-layout layout">
      <div className="w-full max-w-7xl h-[82dvh] grid grid-cols-[1fr_auto] gap-6">
        ...
        <div className="w-[320px] h-full grid grid-rows-2 gap-6">
          ...
          <Link href="/dashboard/readiness-score" className="bg-[#D9D9D92B] w-full h-full flex flex-col items-center justify-center gap-4 rounded-4xl">
            {isLoading ? (
              <div className="w-full h-full flex items-center justify-center">
                <div className="w-16 h-16 border-4 border-[#201161] border-t-transparent rounded-full animate-spin"></div>
              </div>
            ) : (
              <>
                <h2 className="text-[#201161] text-2xl">
                  Overall Readiness Score
                </h2>
                <p className="text-[#201161] text-xl">
